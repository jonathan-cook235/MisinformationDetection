...
class MMDNE:
    def __init__(self, tree_file_name, cl_label_data,nr_data,save_path, emb_size=128, neg_size=10, hist_len=2, directed=False,
        ...
        self.global_attention = Variable((torch.zeros(1)).type(FType))
...
if __name__ == '__main__':
    ...
    for tree_file_name in trees_to_parse:
        mmdne = MMDNE(tree_file_name=tree_file_name,
