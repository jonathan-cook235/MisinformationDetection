...
class EncoderDecoder(nn.Module):
    ...
    def forward(self, input_dim, hidden_dim, output_dim, tgt_mask, tgt_dim):
        ...
        return self.decode(self.encode(input_dim, hidden_dim, ouput_dim), hidden_dim, output_dim)
    
    def encode(self, input_dim, hidden_dim, output_dim):
        return self.TGS(input_dim, hidden_dim, output_dim)
    
    def decode(self, input_dim, hidden_dim, output_dim):
        return self.veracity_prediction(input_dim, hidden_dim, output_dim)
