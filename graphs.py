...
import os
from utils import parse_edge_line, get_tree_file_names
...
def generate_datum(dumps_dir, dataset, timestamp):
    """
    :return: datum of form (claim, c; list of engagements, S; dynamic graph, G)
    """
    edges, dynamic_graph = generate_dynamic_graph(dumps_dir, dataset, timestamp)
