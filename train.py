...
from encoder_decoder import EncoderDecoder, TGS, veracity_prediction, make_model
...
def train(dataset, args):
    ...
    # Setting up model
    model = make_model(dataset_builder.num_node_features, args.hidden_dim, dataset_builder.num_classes, args)
