...
class GraphEmbedding(EmbeddingModule):
  def __init__(self,
    ...
    super(GraphEmbedding, self).__init__(time_encoder,
                                         # node_features, edge_features, memory,neighbor_finder,
...
class GraphSumEmbedding(GraphEmbedding):
  def __init__(self,
               # memory, node_features, edge_features, neighbor_finder,
               time_encoder, n_layers,
               n_node_features, n_edge_features, n_time_features, embedding_dimension, device,
               n_heads=2, dropout=0.1, use_memory=True):
    super(GraphSumEmbedding, self).__init__(time_encoder=time_encoder,
                                            # memory=memory,
